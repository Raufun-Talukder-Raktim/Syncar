...
CREATE OR REPLACE FUNCTION delete_registrationInfo (l_RID IN Registration2.RID%TYPE) 
RETURN Registration2.VIN%TYPE
IS
    l_count NUMBER := 0;
...
BEGIN
    ...
    ELSE
        SELECT COUNT(OID) INTO l_count
        FROM Registration1@site1 WHERE RID = l_RID;
